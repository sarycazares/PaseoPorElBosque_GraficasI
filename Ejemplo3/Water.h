...
//		Imagenes::Carga(alturas);
//		//en caso del puntero de la imagen sea nulo se brica esta opcion
//		wata = Plano(Imagenes::Ancho(), Imagenes::Alto(), ancho, prof, Imagenes::Dir_Imagen(), 30);
//		deltax = anchof / Imagenes::Ancho();
//		deltaz = proff / Imagenes::Alto();
//		verx = Imagenes::Ancho();
//		verz = Imagenes::Alto();
//		//disponemos la textura del gdi.
//		Imagenes::Descarga();
//
//		Imagenes::Carga(textura);
...
//		gluBuild2DMipmaps(GL_TEXTURE_2D, GL_RGBA, Imagenes::Ancho(), Imagenes::Alto(), GL_RGBA, GL_UNSIGNED_BYTE, Imagenes::Dir_Imagen());
//		Imagenes::Descarga();
//
...
//	void cargadorawa(OpenGLClass* OpenGL, const wchar_t* texturaColor, int numText) {
//
//	}
//
//	Water(HWND hWnd, OpenGLClass* OpenGL, const wchar_t* texturaColor, const wchar_t* texturaNormal,
//		const wchar_t* texturaSpecular, const wchar_t* alturas, float ancho, float prof, int NumText,
//		int NumText2, int NumText3)
//	{
//		anchof = ancho;
//		proff = prof;
//		//cargamos la textura de la figura
...
//		float D;
//
//		//el cuadro del water esta formado por dos triangulos, si difx es mayor que dify 
...
//			//sustituyendo obtenemos la altura de contacto en el water
